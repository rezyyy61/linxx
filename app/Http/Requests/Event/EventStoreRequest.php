...
class EventStoreRequest extends FormRequest
{
    ...
    {
        $this->merge([
            'creator_type'       => $this->input('creator_type')       ?? User::class,
            'creator_id'         => $this->input('creator_id')         ?? auth()->id(),
            'created_by_user_id' => $this->input('created_by_user_id') ?? auth()->id(),
    ...
    public function rules(): array
    {
        return [
            ...
            'creator_type'      => ['required','string','max:255'],
